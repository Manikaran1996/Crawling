...
=============================================== */
    ...
    var useGrouping = true;
        ...
        var demo = new countUp('myTargetElement', 0, 11475, 0, 4, options);
        demo.start();
    	});
	...
	$(document).ready(function(){
        ...
        var demo = new countUp('myTargetElement2', 0, 9928, 0, 4, options);
        demo.start();
    	});
	...
	$(document).ready(function(){
        ...
        var demo = new countUp('myTargetElement3', 0, 36, 0, 4, options);
        demo.start();
    	});
	...
	$(document).ready(function(){
        ...
        var demo = new countUp('myTargetElement4', 0, 500, 0, 4, options);
        demo.start();
        });
        ...
        $('.counter-style').appear(function () {
            ...
            var demo = new countUp('myTargetElement5', 0, 29, 0, 4, options);
            demo.start();
        });

        $('.counter-style').appear(function () {

            var demo = new countUp('myTargetElement6', 0, 100, 0, 4, options);
            demo.start();
        });
        ...
        $(document).ready(function () {
            ...
            $('.counter-style').appear(function () {
                ...
                var demo = new countUp('myTargetElement101', 0, 100, 0, 4, options);
                demo.start();
            });
        ...
        $(document).ready(function () {
            ...
            $('.counter-style').appear(function () {
                ...
                var demo = new countUp('myTargetElement102', 0, 100, 0, 4, options);
                demo.start();
            });
        ...
        $(document).ready(function () {
            ...
            $('.counter-style').appear(function () {
                ...
                var demo = new countUp('myTargetElement103', 0, 8431, 0, 4, options);
                demo.start();
            });
        ...
        $(document).ready(function () {
            ...
            $('.counter-style').appear(function () {
                ...
                var demo = new countUp('myTargetElement201', 0, 100, 0, 4, options);
                demo.start();
            });
        ...
        $(document).ready(function () {
            ...
            $('.counter-style').appear(function () {
                ...
                var demo = new countUp('myTargetElement202', 0, 100, 0, 4, options);
                demo.start();
            });
        ...
        $(document).ready(function () {
            ...
            $('.counter-style').appear(function () {
                ...
                var demo = new countUp('myTargetElement203', 0, 100, 0, 4, options);
                demo.start();
            });
